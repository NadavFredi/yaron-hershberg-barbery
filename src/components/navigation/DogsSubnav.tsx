import { Dog, Tag, Layers } from "lucide-react"
import { cn } from "@/lib/utils"

export const DOGS_SECTIONS: Array<{
...
interface DogsSubnavProps {
    activeMode: "list" | "category1" | "category2"
    onModeChange: (mode: "list" | "category1" | "category2") => void
}

export function DogsSubnav({ activeMode, onModeChange }: DogsSubnavProps) {
    return (
        <div
