...
export function CustomerTypeDeleteDialog({ open, name, isSubmitting = false, onConfirm, onClose }: CustomerTypeDeleteDialogProps) {
    return (
        <AlertDialog
            open={open}
            onOpenChange={(next) => {
        ...
        >
            <AlertDialogContent dir="rtl">
                <AlertDialogHeader>
                    <AlertDialogTitle className="text-right">מחיקת סוג לקוח</AlertDialogTitle>
                    <AlertDialogDescription className="text-right">
                        האם אתה בטוח שברצונך למחוק את הסוג "{name}"? הלקוחות המשויכים לו יישארו ללא סוג.
                    </AlertDialogDescription>
                </AlertDialogHeader>
