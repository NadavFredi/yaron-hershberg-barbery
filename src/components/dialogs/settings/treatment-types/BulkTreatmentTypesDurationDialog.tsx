...
type TreatmentTypeSize = "small" | "medium" | "medium_large" | "large"

interface BulkTreatmentTypesDurationDialogProps {
    open: boolean
    onOpenChange: (open: boolean) => void
    isProcessing: boolean
    onConfirm: (sizeClass: TreatmentTypeSize | null) => void
}

const SIZE_OPTIONS: Array<{ value: TreatmentTypeSize | "none"; label: string }> = [
...
export function BulkTreatmentTypesDurationDialog({ open, onOpenChange, isProcessing, onConfirm }: BulkTreatmentTypesDurationDialogProps) {
    const [selectedSize, setSelectedSize] = useState<TreatmentTypeSize | "none" | "">("")
