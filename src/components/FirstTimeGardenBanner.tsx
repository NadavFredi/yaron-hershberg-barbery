...
import { Clock, Calendar, Sparkles, CheckCircle, Star, Lightbulb } from "lucide-react"
    ...
    return (
        <Card className="border-amber-200 bg-gradient-to-r from-amber-50 to-orange-50 shadow-lg">
            <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3 text-center flex items-center justify-center gap-2" dir="rtl">
                ...
                <p className="text-sm text-gray-600 text-right mt-4 flex items-center gap-1.5 justify-end" dir="rtl">
                    <Lightbulb className="h-4 w-4 inline text-amber-500" />
