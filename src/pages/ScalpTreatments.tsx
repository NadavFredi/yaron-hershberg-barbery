                        ...
                        <Card className="bg-white/90 backdrop-blur-sm shadow-xl border-0 rounded-3xl p-8 md:p-12">
                            <CardContent className="p-0">
                                ...
                                <div className="space-y-8">
                                    {/* Introduction */}
                                    <div className="bg-gradient-to-r from-red-50 to-rose-50 rounded-2xl p-6 border-r-4 border-red-400">
                                    ...
                                    <div className="pt-4">
                                        <Button
                                            asChild
                                            size="lg"
                                            className="w-full bg-gradient-to-r from-red-600 to-pink-600 text-white hover:from-red-700 hover:to-pink-700 text-lg px-8 py-6 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all"
                                        >
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="pt-4">
                                        <Button
                                            asChild
                                            size="lg"
                                            className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 text-lg px-8 py-6 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all"
                                        >
                                            <Link to="/setup-appointment" className="flex items-center justify-center gap-2">
                                                קבעו תור לאבחון וטיפול
                                                <ArrowRight className="h-5 w-5" />
