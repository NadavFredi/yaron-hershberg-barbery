...
export default function DogsListPage() {
    ...
    const appliedCategoryFromUrlRef = useRef({ category2: false })
    ...
    const fetchDogs = async () => {
        try {
            ...
            const categoriesData = dogIds.length > 0
                ? await supabase
    ...
    const filteredDogs = dogs.filter((dog) => {
        ...
        // Category filter (dog_categories)
        if (categoryFilter) {
            const hasCategory = dog.dog_categories?.some((category: any) =>
    ...
    useEffect(() => {
        setCurrentPage(1)
    }, [searchTerm, ownerNameFilter, ownerPhoneFilter, ownerEmailFilter, breedFilter, sizeFilter, categoryFilter, ownerCategoryFilter])
                ...
                <CardContent>
                    ...
                    <div className="mb-6 space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                <Label className="text-sm mb-2 block">קטגוריית כלב</Label>
                                <AutocompleteFilter
                        ...
                        {(ownerNameFilter || ownerPhoneFilter || ownerEmailFilter || breedFilter || sizeFilter !== "all" || categoryFilter || ownerCategoryFilter !== "all") && (
                            <Button
                                variant="outline"
                                onClick={() => {
                                    setOwnerNameFilter("")
                                ...
                                <Table className="w-full table-fixed" containerClassName="!overflow-visible">
                                    <TableHeader>
                                        <TableRow className="bg-[hsl(228_36%_95%)] [&>th]:sticky [&>th]:top-0 [&>th]:z-10 [&>th]:bg-[hsl(228_36%_95%)]">
                                            ...
                                            <TableHead className="text-right align-middle font-medium text-primary font-semibold w-[140px]">קטגוריה</TableHead>
                                            ...
                                            <TableHead className="text-right align-middle font-medium text-primary font-semibold w-[140px]">פעולות</TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
