                                            ...
                                            >
                                                        ...
                                                        onClick={() => {
                                                            const dogPayload = {
                                                                ...
                                                                owner: selectedClient ? {
                                                                    ...
                                                                    customerTypeName: selectedClient.customerTypeName,
                                                                    phone: selectedClient.phone,
                                                                    email: selectedClient.email,
                                                                    clientId: selectedClient.clientId,
                                                                    recordId: selectedClient.recordId || selectedClient.clientId,
                                                                } : undefined,
                                                                customer_id: selectedClient?.clientId,
                                                            }
                                                            dispatch(setSelectedDog(dogPayload))
                                                            dispatch(setIsDogDetailsOpen(true))
                                                            handleOpenChange(false) // Close client sheet when opening dog sheet
                                                        }}
                                                ...
                                                <div className="mt-1 flex items-center justify-between">
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() => handleShowDogAppointments(dog)}
                                                    >
