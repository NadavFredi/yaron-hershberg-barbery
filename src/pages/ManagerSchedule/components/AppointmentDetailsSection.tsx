...
const themeClasses: Record<ThemeKey, {
    ...
    blue: {
        ...
        title: "text-primary",
        label: "text-primary",
        viewText: "text-primary",
        input: "border border-primary/20 focus:outline-none focus:ring-1 focus:ring-primary",
        editButton: "text-primary hover:text-primary hover:bg-primary/20",
        saveButton: "bg-primary hover:bg-primary/90",
        saveButtonText: "text-white text-xs",
        cancelButton: "text-xs"
    },
    mint: {
