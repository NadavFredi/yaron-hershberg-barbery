...
echo "3. Run: supabase functions deploy list-owner-dogs"
echo "4. Run: supabase functions deploy check-dog-registration"
echo "5. Run: supabase functions deploy get-dog-appointments"
