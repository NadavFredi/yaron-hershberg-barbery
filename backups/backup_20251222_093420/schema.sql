...
CREATE INDEX "idx_faqs_is_visible" ON "public"."faqs" USING "btree" ("is_visible") WHERE ("is_visible" = true);
...
CREATE POLICY "Managers can delete FAQs" ON "public"."faqs" FOR DELETE USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'manager'::"text")))));



CREATE POLICY "Managers can insert FAQs" ON "public"."faqs" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'manager'::"text")))));
...
CREATE POLICY "Managers can update FAQs" ON "public"."faqs" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'manager'::"text")))));
...
CREATE POLICY "Managers can view all FAQs" ON "public"."faqs" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'manager'::"text")))));
